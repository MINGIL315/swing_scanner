...
from scanner.us.patterns import ALL_DETECTORS
from scanner.us.patterns.base import PatternResult
from scanner.us.patterns.trend import detect_weekly_trend
from scanner.us.scoring.scorer import ScoringInput, calculate_confidence_score
...
def _get_weekly_trend(daily_df: pd.DataFrame) -> tuple[str, float]:
    ...
    """
    try:
        from scanner.us.patterns.pullback import _resample_weekly  # 재사용
